...
const mainServices = [
  {
    ...
    label: "가장 먼저 추천",
    title: "오늘의 해말아",
    desc: "고민을 입력하면 오늘 할지 말지 바로 판단해주는 핵심 서비스",
    cta: "고민 판단하기",
    emoji: "⚖️",
  },
  {
    ...
    label: "가볍게 즐기기",
    title: "랜덤 선택",
    desc: "운세, 선택, 미션, 기분 전환을 버튼 한 번으로 뽑는 랜덤 콘텐츠",
    cta: "랜덤 뽑기",
    emoji: "🎲",
  },
  {
    ...
    label: "재방문 유도",
    title: "꿈해몽 로또",
    desc: "어젯밤 꿈을 입력하면 재미용 로또 번호 조합을 생성",
    cta: "꿈 번호 보기",
    emoji: "🌙",
  },
];
...
const reasons = [
  {
    title: "짧고 강한 결과",
    body: "긴 설명보다 바로 쓰는 결과를 먼저 보여줍니다.",
  },
  {
    title: "계속 누르게 되는 구조",
    body: "오늘의 판단, 랜덤 결과, 꿈 번호가 서로 연결됩니다.",
  },
  {
    title: "광고형 콘텐츠에 적합",
    body: "검색 유입과 반복 방문을 노리는 가벼운 페이지 구조입니다.",
  },
];
            ...
            <div className="relative grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
              <div>
                ...
                <p className="mt-6 max-w-2xl text-base font-semibold leading-8 text-white/70 sm:text-lg">
                  오늘 할지 말지, 랜덤 선택, 꿈해몽 로또까지. 회원가입 없이
                  바로 쓰는 무료 결정 콘텐츠 플랫폼입니다.
                </p>
